...
export default function Footer() {
  ...
  return (
    <footer className="flex justify-center bg-p-dark-blue w-full">
      <div className="flex flex-col xl:flex-row items-center xl:items-start xl:justify-between gap-8 font-pubSans text-n-light-grey py-10 xl:px-40 xl:w-[1920px]">
