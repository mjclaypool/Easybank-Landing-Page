...
export default function Hero() {
  return (
    <div className="relative flex justify-center bg-n-light-grey w-full">
      <div className="flex flex-col xl:flex-row-reverse xl:justify-between xl:max-h-[646px] w-[1920px]">
        <div>
